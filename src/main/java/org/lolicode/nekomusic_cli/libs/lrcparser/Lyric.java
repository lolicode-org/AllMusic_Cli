package org.lolicode.nekomusic_cli.libs.lrcparser;

import org.lolicode.nekomusic_cli.libs.lrcparser.parser.Sentence;
...
public class Lyric{
	...
	public void merge(Lyric lyric){
		...
		for (Sentence sentence : lyric.sentences) {
